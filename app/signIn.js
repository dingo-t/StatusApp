        ...
        <View className="gap-10">
          ...
          <View className="gap-4">
            ...
            <View>
                    ...
                    <TouchableOpacity onPress={handleLogin} style={{backgroundColor: "#5252ad", marginHorizontal: wp(5), borderRadius: 13,  justifyContent: 'center', alignItems: 'center', height: hp(6.5)}} >
